                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form>
                                    <div class ="row">
                                        ...
                                        <div class="form-row col-md-7" >    
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="categoryFoodId" value="${food.foodCate.foodCateName}" required=""/>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Status</label>
                                    ...
                                    <input type="submit" name="action" class="btn btn-primary" value="UpdateFoodByManager"/>
