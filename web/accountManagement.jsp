    ...
    <body>
        ...
        <jsp:include page="layoutAdmin.jsp"></jsp:include>
            ...
            <form action="MainController">
                <input name="searchAccountByAdmin" type="text" placeholder="Seach by user Full Name" value="${param.searchAccountByAdmin}">
                <button type="submit" name="action" class="site-btn" value="SearchAccountByAdmin">SEARCH</button>
            </form>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    <c:forEach items="${VIEW_ACCOUNT}" var="x">
                    <form action ="MainController">
                        <tr>
                            ...
                            <td><input type = "text" name="password" value="${x.password}" readonly=""""/></td>                               
                            <td><input type = "text" name="role" value="${x.role.roleId}" required=""/></td>                               
